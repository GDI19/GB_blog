...
class User(db.Model, UserMixin):
    ...
    username = Column(String(120), unique=True, nullable=False, default="", server_default="")
    ...
    is_staff = Column(Boolean(name='is_staff'), nullable=False)
    ...
    def __repr__(self) -> str:
        return f",User #{self.id} {self.username!r} {self.email}>"
